...
#[derive(Debug)]
pub struct GroupSchema(pub(super) Vec<ValueSchema>,pub(super) HashMap<String,usize>);
...
#[derive(Debug)]
pub struct MapSchema<K,V>(pub(super) K,pub(super) V,pub(super) Option<String>,pub(super) Option<String>,pub(super) Option<String>);
...
#[derive(Debug)]
pub struct ListSchema<T>(pub(super) T,pub(super) Option<(Option<String>,Option<String>)>);
